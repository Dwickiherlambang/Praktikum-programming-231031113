...
# Input waktu pertama
print('Pertambahan waktu')
jam1 = int(input("Masukkan jam pertama: "))
menit1 = int(input("Masukkan menit ke : "))
detik1 = int(input("Masukkan detik ke : "))

# Input waktu kedua
jam2 = int(input("\nMasukkan jam kedua: "))
menit2 = int(input("Masukkan menit ke : "))
detik2 = int(input("Masukkan detik ke : "))
print('_'*30,'+')
...
print(f"\nTotal waktu: {total_jam} jam, {total_menit} menit, {total_detik} detik")
...
# Input waktu pertama
print('Pengurangan waktu')
jam1 = int(input("\nMasukkan jam pertama: "))
menit1 = int(input("Masukkan menit ke : "))
detik1 = int(input("Masukkan detik ke : "))
